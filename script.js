...
const scenes = {
  ...
  // =========================================================
  // BI-WEEKLY UNIT 1 — THE NUCLEAR COMEBACK
  // Japan, reactor restart, energy security & spent fuel
  //
  // SESSION RULE:
  // EACH 30-MINUTE SESSION ENDS WITH AN EMAIL HOMEWORK TASK
  //
  // C1 LANGUAGE TARGETS
  // • strength of claims / evidential precision
  // • reduced participle clauses
  // • inverted conditionals: should / were / had
  // • nominalisation in technical reporting
  // • policy justification vs safety justification
  // =========================================================


  // =========================================================
  // SESSION 1 — WHY NUCLEAR, WHY NOW?
  // =========================================================
...
Japan shut down its nuclear fleet after Fukushima.

Now nuclear generation is returning.

Before reading anything, discuss:

• Why might Japan want more nuclear generation now?
• What has changed since 2011?
• Does a strong energy argument strengthen a safety argument?
• What would YOU want to know before supporting a reactor restart?
• Can a country need nuclear power while still being right to delay a particular restart?

Today's central question:

DOES NEEDING NUCLEAR POWER
MEAN A REACTOR SHOULD RESTART?
    `,
    choices: [
      { text: "Examine the case", next: "scene2_article" }
    ]
  },
  ...
  scene2_article: {
    type: "text",
    text: `
READING 1 — WHY JAPAN WANTS THE REACTOR BACK

Read:

"Nuclear reactor restart in Japan will likely displace
...
• why Unit 6 matters;
• Japan's dependence on imported fossil fuels;
• the amount of generation the reactor could provide;
• the connection between nuclear generation and LNG imports;
• what the article DOES and DOES NOT claim about safety.

Do not simply collect numbers.

Look for the ARGUMENT behind the numbers.
    `,
    choices: [
      {
        text: "Open EIA article ↗",
        url: "https://www.eia.gov/todayinenergy/detail.php?id=67244",
        target: "_blank"
      },
      {
        text: "I've finished reading",
        next: "scene3_reading_check"
      }
    ]
  },


  scene3_reading_check: {
    type: "text",
    shuffleOptions: true,
    text: `
The restart of Kashiwazaki-Kariwa Unit 6 could reduce
Japan's consumption of imported natural gas.

Which conclusion is BEST supported by the EIA article?
    `,
    choices: [
      {
        text: "Because the restart reduces LNG consumption, the reactor can be assumed to satisfy every relevant safety requirement.",
        next: "scene3_retry"
      },
      {
        text: "The restart could strengthen Japan's energy-security position by replacing some fossil-fuel generation.",
        next: "scene4_claim_strength"
      },
      {
        text: "The restart demonstrates that imported LNG is no longer necessary for Japan's electricity system.",
        next: "scene3_retry"
      },
      {
        text: "The economic case for nuclear generation removes the need for plant-specific safety justification.",
        next: "scene3_retry"
      }
    ]
  },
...
The article supports an ENERGY argument:

MORE NUCLEAR GENERATION
→ LESS FOSSIL-FUEL GENERATION
→ POTENTIALLY FEWER LNG IMPORTS

It does NOT follow that:

ENERGY NEED
= AUTOMATIC SAFETY JUSTIFICATION

A C1 professional needs to control
the logical distance between those claims.
    `,
    choices: [
      { text: "Reassess the conclusion", next: "scene3_reading_check" }
    ]
  },


  // ---------------------------------------------------------
  // GRAMMAR 1 — EVIDENTIAL STRENGTH
  // ---------------------------------------------------------

  scene4_claim_strength: {
    type: "text",
    text: `
C1 LANGUAGE — HOW STRONG IS YOUR CLAIM?
...
Now add another useful distinction:

X SUPPORTS THE CASE FOR Y

does NOT mean:

X IS SUFFICIENT TO JUSTIFY Y

That distinction matters in technical,
regulatory and safety discussions.
    `,
    choices: [
      { text: "Test the distinction", next: "scene5_claim_mc" }
    ]
  },
  ...
  scene5_claim_mc: {
    ...
    shuffleOptions: true,
    text: `
Electricity demand is increasing and the reactor
could reduce fossil-fuel imports.

Which statement is the most professionally defensible?
    `,
    choices: [
      {
        text: "The reduction in fossil-fuel dependence proves that restarting the reactor is safe.",
        next: "scene5_retry"
      },
      {
        text: "The energy-security benefit supports the case for nuclear generation, but does not in itself establish that a specific reactor should restart.",
        next: "scene6_claim_scramble"
      },
      {
        text: "The energy-security benefit appears to make further safety assessment largely unnecessary.",
        next: "scene5_retry"
      },
      {
        text: "Because nuclear generation can replace imported gas, the technical case for restart has effectively been demonstrated.",
        next: "scene5_retry"
      }
    ]
  },
  ...
  scene5_retry: {
    type: "text",
    text: `
Watch the LOGIC, not only the grammar.
...
The energy-security argument may be strong
without resolving the plant-specific safety case.
    `,
    choices: [
      { text: "Try again", next: "scene5_claim_mc" }
    ]
  },


  scene6_claim_scramble: {
    type: "scramble",
    disableSpeech: true,
    text: `
Build ONE technically careful statement.

The sentence must distinguish:
...
SAFETY JUSTIFICATION
    `,
    scramble: [
      "that the reactor satisfies all restart requirements.",
      "may support the case for nuclear generation,",
      "but does not in itself demonstrate",
  ...
  scene7_video_intro: {
    type: "text",
    text: `
FROM ARGUMENT TO EVENT

The EIA gives us the energy-system argument.

Now watch what actually happened at
Kashiwazaki-Kariwa.

Listen particularly for:

• how long the plant had been offline;
• what the restart means for Japan;
• the role of imported fossil fuels;
• how the restart fits the wider nuclear strategy.

Do not try to remember every number.

Listen for RELATIONSHIPS between ideas.
    `,
    choices: [
      { text: "Watch the report", next: "scene8_video" }
    ]
  },
  ...
  scene8_video: {
    ...
    youtube: "https://www.youtube.com/watch?v=y2vg1h6kGWI",

    text: `
CNA

Japan restarts operations at world's largest nuclear plant

21 May 2026

Watch the report.

Think about this question while listening:

Is this primarily a story about a reactor,
or about Japan's changing energy strategy?
    `,
    ...
    questions: [
      {
        text: "Which broader objective is associated with Japan's nuclear revival?",
        options: [
          "Eliminating all fossil-fuel generation immediately",
          "Reducing dependence on imported fossil fuels",
          "Replacing nuclear power with renewable generation",
          "Closing older generating stations regardless of demand"
        ],
        correct: 1
      },
      {
        text: "Which interpretation best captures the significance of the restart?",
        options: [
          "It is part of a broader attempt to revive Japan's nuclear sector.",
          "It demonstrates that all Japanese reactors will now restart.",
          "It ends the political debate surrounding nuclear power in Japan.",
          "It means Japan no longer requires imported energy."
        ],
        correct: 0
      },
      {
        text: "Which statement uses the most defensible professional language?",
        options: [
          "The restart proves that public concerns after Fukushima have been resolved.",
          "The restart establishes that nuclear generation is Japan's safest energy option.",
          "The restart indicates a significant change in Japan's approach to nuclear generation.",
          "The restart confirms that nuclear power will dominate Japan's electricity mix."
        ],
        correct: 2
      },
      {
        text: "What would require evidence BEYOND this news report?",
        options: [
          "Whether the unit has returned to commercial operation",
          "Whether the restart forms part of Japan's nuclear revival",
          "Whether nuclear generation may reduce fossil-fuel imports",
          "Whether every relevant safety vulnerability has been satisfactorily addressed"
        ],
        correct: 3
      }
    ],
    ...
    endings: {
      high: "scene9_participle_intro",
      medium: "scene9_participle_intro",
      low: "scene8_retry"
    }
  },
...
SAFETY
→ requires evidence beyond the energy argument

Watch again and keep those levels separate.
    `,
    choices: [
      { text: "Watch again", next: "scene8_video" }
    ]
  },


  // ---------------------------------------------------------
  // GRAMMAR 2 — PARTICIPLE CLAUSES
  // ---------------------------------------------------------

  scene9_participle_intro: {
    type: "text",
    text: `
C1 COMPRESSION — PARTICIPLE CLAUSES

Technical English often compresses information.

FULL:

Because the reactor had remained offline for more
than a decade, its return attracted considerable attention.

COMPRESSED:

Having remained offline for more than a decade,
the reactor's return attracted considerable attention.

Another useful pattern:

Given the renewed demand for electricity,
the government has strengthened its support for nuclear power.

GIVEN + NOUN PHRASE

often means:

WHEN WE CONSIDER / IN VIEW OF...
    `,
    choices: [
      { text: "Use the structure", next: "scene10_participle_mc" }
    ]
  },


  scene10_participle_mc: {
    type: "text",
    shuffleOptions: true,
    text: `
Which sentence is both grammatically sound
and logically controlled?
    `,
    choices: [
      {
        text: "Having reduced fossil-fuel imports, the reactor was automatically considered safe.",
        next: "scene10_retry"
      },
      {
        text: "Given Japan's dependence on imported fuels, increasing nuclear generation may offer significant energy-security benefits.",
        next: "scene11_participle_scramble"
      },
      {
        text: "Given that depending on imported fuels, nuclear generation proves necessary.",
        next: "scene10_retry"
      },
      {
        text: "Having Japan depended on imported fuels, the reactor was restarted.",
        next: "scene10_retry"
      }
    ]
  },
...
Given Japan's dependence on imported fuels...
...
But a sophisticated structure cannot rescue
an unjustified conclusion.
    `,
    choices: [
      { text: "Try again", next: "scene10_participle_mc" }
    ]
  },


  scene11_participle_scramble: {
    type: "scramble",
    disableSpeech: true,
    text: `
Build ONE C1-level technical statement.

Pay attention to the relationship between
ENERGY STRATEGY and SAFETY OVERSIGHT.
    `,
    scramble: [
      "regardless of the wider energy-policy benefits.",
      "regulatory scrutiny remains essential",
      "Given",
      "Japan's renewed interest in nuclear generation,"
    ],
    correct: [
      "Given",
      "Japan's renewed interest in nuclear generation,",
  ...
  scene12_session1_case: {
    type: "text",
    shuffleOptions: true,
    text: `
A senior manager says:

"Japan needs the electricity and wants to reduce LNG imports.
That makes the restart clearly justified."

Which response is strongest?
    `,
    choices: [
      {
        text: "I agree. Energy security is ultimately more important than the remaining technical uncertainties.",
        next: "scene12_retry"
      },
      {
        text: "The energy-security argument is significant; however, it supports the policy case for nuclear generation rather than replacing plant-specific safety justification.",
        next: "scene13_homework_intro"
      },
      {
        text: "That conclusion is incorrect because energy security has no relevance to nuclear policy.",
        next: "scene12_retry"
      },
      {
        text: "The restart may be acceptable provided that nuclear power is economically preferable to LNG.",
        next: "scene12_retry"
      }
    ]
  },
  ...
  scene12_retry: {
    type: "text",
    text: `
The best response does NOT dismiss
the energy argument.

It limits what that argument can prove.

A useful C1 pattern:

X IS SIGNIFICANT;
HOWEVER,
IT DOES NOT IN ITSELF ESTABLISH Y.

That is stronger professional reasoning
than simply agreeing or disagreeing.
    `,
    choices: [
      { text: "Reassess", next: "scene12_session1_case" }
    ]
  },
  ...
  scene13_homework_intro: {
    type: "text",
    text: `
SESSION 1 — HOMEWORK

Before finishing today's session,
turn the discussion into a short professional response.

Imagine a colleague asks:

"Japan needs additional electricity and wants
to reduce its dependence on imported fossil fuels.

Doesn't that make reactor restart an obvious decision?"

Your answer should acknowledge the energy argument
WITHOUT allowing it to replace the safety argument.
    `,
    choices: [
      { text: "Write Session 1 homework", next: "scene14_email_day1" }
    ]
  },
  ...
  scene14_email_day1: {
    type: "email",
    awardOnEnter: 5,
    text: `HOMEWORK 1 — INTERNAL RESPONSE

Write approximately 100–130 words.

A colleague argues:

"Japan's need for additional electricity and reduced
dependence on imported fossil fuels makes reactor
restart an obvious decision."

Respond professionally.

Your answer should:

• acknowledge the energy-security argument;
• distinguish energy-policy justification from
  plant-specific safety justification;
• explain what the available evidence can and cannot establish.

Try to use naturally:

• suggests / indicates / supports the case for;
• does not in itself demonstrate / establish;
• Given + noun phrase
  OR
  Having + past participle.
...
CONTROL THE STRENGTH OF THE CLAIM.`,
    teacherEmail: "xavier.benitz@gmail.com",
    emailSubject: "Nuclear Safety — Session 1 Homework",
    emailBody: "",
    next: "scene15_day1_complete"
  },


  scene15_day1_complete: {
    type: "text",
    text: `
✅ SESSION 1 COMPLETE
...
SESSION 2 begins with a different question:

A reactor can return to service.

BUT WHAT HAPPENS TO THE FUEL?
    `,
    choices: [
      { text: "Start Session 2", next: "scene16_day2_intro" }
    ]
  },


  // =========================================================
  // SESSION 2 — GENERATION HAS CONSEQUENCES
  // =========================================================

  scene16_day2_intro: {
    type: "text",
    text: `
SESSION 2 — THE BACK END OF THE ARGUMENT

A successful restart produces electricity.

It also produces spent nuclear fuel.

Before reading, discuss:

• When does spent-fuel capacity become an operational issue?
• Can a restart strategy be credible without a long-term fuel strategy?
• What is the difference between an interim measure and a permanent solution?
• At what point does storage capacity constrain generation?
• Should unresolved long-term disposal affect decisions made today?

Now examine Japan's problem.
    `,
    choices: [
      { text: "Read the AP report", next: "scene17_article" }
    ]
  },
  ...
  scene17_article: {
    type: "text",
    text: `
READING 2 — THE OTHER SIDE OF THE RESTART

Read:

"Reactor reboot at world's largest nuclear plant
highlights flaws in Japan's radioactive waste plans"
...
• reprocessing;
• permanent disposal;
• why restarting reactors can intensify
  an existing fuel-management problem.

Look particularly for the difference between:
...
LONG-TERM RESOLUTION.
    ...
    choices: [
      {
        text: "Open AP article ↗",
        url: "https://apnews.com/article/f2cea3833ee52ef76d57a834a3d048e1",
        target: "_blank"
      },
      {
        text: "I've finished reading",
        next: "scene18_ap_check"
      }
    ]
  },
  ...
  scene18_ap_check: {
    ...
    shuffleOptions: true,
    text: `
Which conclusion most accurately reflects
the tension described in the article?
    `,
    choices: [
      {
        text: "Restarting reactors may increase electricity supply while simultaneously increasing pressure on an unresolved spent-fuel management system.",
        next: "scene19_nominalisation_intro"
      },
      {
        text: "Japan has already established a permanent disposal solution, so spent-fuel capacity should no longer constrain future operation.",
        next: "scene18_retry"
      },
      {
        text: "Dry-cask storage has permanently resolved Japan's high-level radioactive waste problem.",
        next: "scene18_retry"
      },
      {
        text: "The restart itself demonstrates that spent-fuel storage capacity is sufficient for long-term nuclear expansion.",
        next: "scene18_retry"
      }
    ]
  },
...
the long-term problem.
    `,
    choices: [
      { text: "Reassess", next: "scene18_ap_check" }
    ]
  },


  // ---------------------------------------------------------
  // GRAMMAR 3 — NOMINALISATION
  // ---------------------------------------------------------

  scene19_nominalisation_intro: {
    type: "text",
    text: `
C1 TECHNICAL STYLE — NOMINALISATION

Technical reporting often shifts the focus
from PEOPLE to PROCESSES.

VERB:

Operators must assess storage capacity.

NOMINALISED:

An assessment of storage capacity is required.

VERB:

The utility implemented additional safeguards.

NOMINALISED:

The implementation of additional safeguards...

Useful nuclear/reporting nouns:
...
Nominalisation can improve formal register.

But too much of it makes writing vague and heavy.
    `,
    choices: [
      { text: "Test the register", next: "scene20_nominalisation_mc" }
    ]
  },


  scene20_nominalisation_mc: {
    type: "text",
    shuffleOptions: true,
    text: `
A technical note needs to describe
the fuel-management issue.

Which sentence best combines precision
with appropriate formal register?
    `,
    choices: [
      {
        text: "They need to find somewhere to put the spent fuel before things become difficult.",
        next: "scene20_retry"
      },
      {
        text: "The continued expansion of nuclear generation requires adequate provision for the management, storage and eventual disposal of spent fuel.",
        next: "scene21_nominalisation_scramble"
      },
      {
        text: "The storage of the fuel is being a problem which should receive a solution.",
        next: "scene20_retry"
      },
      {
        text: "Spent fuel has to be disposed because its accumulation would be very problematic for everybody involved.",
        next: "scene20_retry"
      }
    ]
  },
  ...
  scene20_retry: {
    type: "text",
    text: `
TECHNICAL REGISTER DOES NOT MEAN:
...
spent-fuel management.
    `,
    choices: [
      { text: "Try again", next: "scene20_nominalisation_mc" }
    ]
  },


  scene21_nominalisation_scramble: {
    type: "scramble",
    disableSpeech: true,
    text: `
Build ONE formal technical statement.

Keep the relationship between
STORAGE LIMITATIONS and OPERATION clear.
    `,
    scramble: [
      "continued reactor operation.",
      "Without a sustainable spent-fuel strategy,",
      "may ultimately constrain",
      "storage limitations"
    ],
    correct: [
      "Without a sustainable spent-fuel strategy,",
    ...
    next: "scene22_logic_precision"
  },


  scene22_logic_precision: {
    type: "text",
    shuffleOptions: true,
    text: `
The previous sentence describes a possible constraint.

Which version is even more precise?
    `,
    choices: [
      {
        text: "Without a sustainable spent-fuel strategy, storage limitations may ultimately constrain continued reactor operation.",
        next: "scene23_conditional_intro"
      },
      {
        text: "Without continued reactor operation, spent-fuel strategy may ultimately constrain storage limitations.",
        next: "scene22_retry"
      },
      {
        text: "Without storage limitations, continued reactor operation may ultimately constrain spent-fuel strategy.",
        next: "scene22_retry"
      },
      {
        text: "Without constraining reactor operation, spent-fuel storage may ultimately sustain the strategy.",
        next: "scene22_retry"
      }
    ]
  },
...
insufficient or restricted storage capacity

POTENTIAL CONSEQUENCE

continued operation may be constrained

Advanced vocabulary should make
the relationship MORE precise,
not obscure it.
    `,
    choices: [
      { text: "Try again", next: "scene22_logic_precision" }
    ]
  },


  // ---------------------------------------------------------
  // GRAMMAR 4 — INVERTED CONDITIONALS
  // ---------------------------------------------------------

  scene23_conditional_intro: {
    type: "text",
    text: `
C1 CONDITIONALS — REMOVE "IF"

Formal English often uses inversion.

NORMAL:

If storage capacity becomes insufficient,
additional measures will be required.

FORMAL:

SHOULD storage capacity become insufficient,
additional measures will be required.


NORMAL:

If additional capacity were available,
the immediate constraint would be reduced.

FORMAL:

WERE additional capacity available,
the immediate constraint would be reduced.


PAST COUNTERFACTUAL:

If the problem had been resolved earlier,
the current constraint might have been less severe.

FORMAL:

HAD the problem been resolved earlier,
the current constraint might have been less severe.
    `,
    choices: [
      { text: "Apply the pattern", next: "scene24_conditional_mc" }
    ]
  },


  scene24_conditional_mc: {
    type: "text",
    shuffleOptions: true,
    text: `
The plant currently has storage capacity,
but future capacity could become restrictive.

Which formal contingency statement is correct?
    `,
    choices: [
      {
        text: "Should storage capacity become insufficient, additional fuel-management measures would need to be considered.",
        next: "scene25_conditional_scramble"
      },
      {
        text: "Should storage capacity became insufficient, additional measures will have considered.",
        next: "scene24_retry"
      },
      {
        text: "Were storage capacity will become insufficient, additional measures would be required.",
        next: "scene24_retry"
      },
      {
        text: "Had storage capacity becomes insufficient, additional measures will be considered.",
        next: "scene24_retry"
      }
    ]
  },
  ...
  scene24_retry: {
    type: "text",
    text: `
FORMAL FUTURE POSSIBILITY:

SHOULD + SUBJECT + BASE VERB

Should capacity BECOME insufficient...
...
Had the issue been resolved...
    `,
    choices: [
      { text: "Try again", next: "scene24_conditional_mc" }
    ]
  },


  scene25_conditional_scramble: {
    type: "scramble",
    disableSpeech: true,
    text: `
Build ONE formal contingency statement.

The risk is FUTURE and POSSIBLE,
not hypothetical past.
    `,
    scramble: [
      "the fuel-management strategy.",
      "become a limiting factor,",
      "Should available storage capacity",
      "the operator would need to reassess"
    ],
    correct: [
      "Should available storage capacity",
      "become a limiting factor,",
    ...
    next: "scene26_integrated_case"
  },


  // ---------------------------------------------------------
  // INTEGRATED PROFESSIONAL CASE
  // ---------------------------------------------------------

  scene26_integrated_case: {
    type: "text",
    text: `
THE RESTART BRIEFING

Management presents four points:

1. Electricity demand is increasing.

2. Additional nuclear generation could reduce
   dependence on imported fossil fuels.

3. The reactor has returned to operation.

4. Spent-fuel storage and long-term disposal
   remain significant strategic issues.

You are asked:

"Does the successful restart mean that expanding
nuclear generation is now straightforward?"

Your answer needs to distinguish:

ENERGY CASE

OPERATIONAL REALITY

SAFETY / REGULATORY JUSTIFICATION

FUEL-CYCLE CONSTRAINTS
    `,
    choices: [
      { text: "Choose the strongest response", next: "scene27_integrated_mc" }
    ]
  },


  scene27_integrated_mc: {
    type: "text",
    shuffleOptions: true,
    text: `
Which answer demonstrates the strongest
C1 professional reasoning?
    `,
    choices: [
      {
        text: "Yes. Once a reactor has restarted successfully, expanding nuclear generation mainly becomes an economic and political decision.",
        next: "scene27_retry"
      },
      {
        text: "Not necessarily. The restart strengthens the practical case for nuclear generation, but continued expansion remains contingent on plant-specific safety justification, regulatory compliance and credible spent-fuel management.",
        next: "scene28_precision"
      },
      {
        text: "No. The existence of unresolved spent-fuel issues demonstrates that additional nuclear generation should not be considered.",
        next: "scene27_retry"
      },
      {
        text: "Probably. Given the reduction in LNG consumption, unresolved fuel-cycle questions are secondary to the wider benefits.",
        next: "scene27_retry"
      }
    ]
  },
...
NUCLEAR EXPANSION IS EASY

or:

NUCLEAR EXPANSION IS IMPOSSIBLE

A stronger professional conclusion can be:
...
REMAINS CONTINGENT ON...
    `,
    choices: [
      { text: "Reassess", next: "scene27_integrated_mc" }
    ]
  },
...
Which sentence makes the LEAST defensible claim?
    `,
    choices: [
      {
        text: "The restart indicates a renewed role for nuclear generation in Japan's energy strategy.",
        next: "scene28_retry"
      },
      {
        text: "Reducing LNG dependence may strengthen the economic case for nuclear generation.",
        next: "scene28_retry"
      },
      {
        text: "Successful commercial operation proves that the long-term spent-fuel problem has been resolved.",
        next: "scene29_precision"
      },
      {
        text: "Continued nuclear expansion remains dependent on more than electricity demand alone.",
        next: "scene28_retry"
      }
    ]
  },
  ...
  scene28_retry: {
    type: "text",
    text: `
Look for the sentence that makes
an unjustified leap.
...
LONG-TERM FUEL-CYCLE RESOLUTION.
    `,
    choices: [
      { text: "Try again", next: "scene28_precision" }
    ]
  },
...
Which sentence makes the BEST use
of a reduced clause?
    `,
    choices: [
      {
        text: "Having considered the available evidence, the restart appears to form part of a broader change in Japanese energy policy.",
        next: "scene30_precision"
      },
      {
        text: "Having the reactor restarted, energy security was improving.",
        next: "scene29_retry"
      },
      {
        text: "Given considering the fuel constraints, additional measures could be required.",
        next: "scene29_retry"
      },
      {
        text: "Having been the demand increased, the government supported nuclear generation.",
        next: "scene29_retry"
      }
    ]
  },
...
Given the current constraints...
    `,
    choices: [
      { text: "Try again", next: "scene29_precision" }
    ]
  },
...
Choose the strongest formal contingency.
    `,
    choices: [
      {
        text: "If fuel storage will become restrictive, the strategy would need revision.",
        next: "scene30_retry"
      },
      {
        text: "Should spent-fuel storage become a significant operational constraint, the strategy would require reassessment.",
        next: "scene31_homework_intro"
      },
      {
        text: "Had spent-fuel storage become restrictive in the future, the strategy will require reassessment.",
        next: "scene30_retry"
      },
      {
        text: "Were spent-fuel storage becomes restrictive, the strategy should have been reassessed.",
        next: "scene30_retry"
      }
    ]
  },
...
Should storage BECOME restrictive...

The inversion creates formal register
without changing the basic conditional meaning.
    `,
    choices: [
      { text: "Try again", next: "scene30_precision" }
    ]
  },
  ...
  scene31_homework_intro: {
    type: "text",
    text: `
SESSION 2 — HOMEWORK

Your director asks for a short internal assessment.

QUESTION:

"Japan's return to nuclear generation appears to
strengthen the argument for reactor restarts elsewhere.

To what extent does the Japanese case support
that conclusion?"

Your response must acknowledge BOTH sides.

Distinguish:

ENERGY-POLICY JUSTIFICATION
...
LONG-TERM STRATEGY
    `,
    choices: [
      { text: "Write Session 2 homework", next: "scene32_email_day2" }
    ]
  },
  ...
  scene32_email_day2: {
    type: "email",
    awardOnEnter: 8,
    text: `HOMEWORK 2 — INTERNAL SAFETY ASSESSMENT

Write approximately 120–160 words.

Question:

"To what extent does Japan's nuclear restart strengthen
the case for further reactor restarts?"

Your response should:

• acknowledge the energy-security argument;
• distinguish policy justification from plant-specific
  safety justification;
• mention the spent-fuel or storage issue;
• identify at least one condition on which further
  expansion would depend.

Try to use naturally:

• indicates / suggests / supports the case for;
• does not in itself demonstrate / establish;
• one nominalised structure:
  assessment / implementation / compliance /
  justification / management;
• one inverted conditional:
  Should...
  Were...
  Had...
• Given...
...
TECHNICALLY DEFENSIBLE.`,
    teacherEmail: "xavier.benitz@gmail.com",
    emailSubject: "Nuclear Safety — Session 2 Homework",
    emailBody: "",
    next: "scene33_email_sent"
  },
  ...
  scene33_email_sent: {
    type: "text",
    text: `
✅ SESSION 2 HOMEWORK SENT

A strong technical professional does not
automatically choose the weakest claim.
...
LIMITATIONS
    `,
    choices: [
      { text: "Final conclusion", next: "scene34_final" }
    ]
  },
...
"Does Kashiwazaki-Kariwa demonstrate that
the nuclear comeback is technically straightforward?"

Which response would you be most comfortable
putting your name under?
    `,
    choices: [
      {
        text: "Yes. The successful restart proves that modern nuclear regulation can resolve the principal technical concerns associated with returning reactors to service.",
        next: "scene34_retry"
      },
      {
        text: "No. The unresolved spent-fuel issue means the restart should not have occurred.",
        next: "scene34_retry"
      },
      {
        text: "The restart indicates that nuclear generation can again make a significant contribution to Japan's energy system. However, it does not in itself establish that further restarts are straightforward; their justification remains contingent on plant-specific safety, regulatory and fuel-management considerations.",
        next: "thank_you_scene"
      },
      {
        text: "Probably. Given Japan's need for energy security, technical concerns should increasingly be assessed in relation to the economic benefits of nuclear generation.",
        next: "scene34_retry"
      }
    ]
  },
...
ACKNOWLEDGES WHAT THE EVIDENCE SUPPORTS

WITHOUT

CLAIMING WHAT THE EVIDENCE CANNOT ESTABLISH.

Try again.
    `,
    choices: [
      { text: "Reassess the conclusion", next: "scene34_final" }
    ]
  },
  ...
  thank_you_scene: {
    type: "text",
    text: `
UNIT COMPLETE — THE NUCLEAR COMEBACK
...
Had the issue been identified earlier,...
...
A technically strong argument identifies
both the benefit and the conditions
under which the conclusion remains valid.
    `,
    endOfCourse: true,
    finishOnEnter: false,
    scoreRaw: 100,
